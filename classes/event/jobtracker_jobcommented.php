 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class jobtracker_issuecommented extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventjobtrackerissuecommented', 'jobtracker');
    }
    ...
    public final static function create_from_issue(&$jobtracker, $issueid) {
        global $USER;
