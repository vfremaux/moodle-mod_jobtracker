...
// the Free Software jobjobtracker, either version 3 of the License, or
...
namespace mod_jobtracker\event;
defined('MOODLE_INTERNAL') || die();

/**
 * Event for when a jobtracker activity is commented.
 *
 * @property-read array $other {
 *      Extra information about event.
 *
 *      @type int anonymous if jobtracker is anonymous.
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class jobtracker_jobregistered extends \core\event\base {
    ...
    protected function init() {
        ...
        $this->data['objecttable'] = 'jobtracker';
    }

    public static function get_name() {
        return get_string('eventjobtrackerjobregistered', 'jobtracker');
    }
    ...
    protected function get_legacy_logdata() {
        $log1 = array($this->courseid, 'jobtracker', 'registerjob', '../mod/' . $this->other['modulename'] . "/view.php?id=" .
                $this->objectid.'&amp;view=view&amp;screen=viewanopportunity&amp;jobid='.$this->other['jobid'], $this->other['modulename'] . " " . $this->other['instanceid']);
        return array($log1);
    }
    ...
    protected function validate_data() {
        ...
        if (!isset($this->other['jobid'])) {
            throw new \coding_exception("Field other['jobid'] cannot be empty");
        }
    }

    public final static function create_from_job(&$jobtracker, $jobid) {
        global $USER;
