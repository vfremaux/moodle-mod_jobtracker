...
$string['pluginname'] = 'Gestion d\'opportunités';
$string['pluginnameplural'] = 'Gestionnaires d\'opportunités';

// Capabilities

$string['jobtracker:addinstance'] = 'Ajouter un gestionnaire d\'opportunités';
$string['jobtracker:canbecced'] = 'Peut être observateur';
$string['jobtracker:comment'] = 'Commenter les opportunités';
$string['jobtracker:configure'] = 'Configurer le gestionnaire';
$string['jobtracker:manage'] = 'Gérer les opportunités';
$string['jobtracker:managepriority'] = 'Gérer la priorité des opportunités';
$string['jobtracker:managewatches'] = 'Gérer les abonnements';
$string['jobtracker:workon'] = 'Travailler des opportunités';
$string['jobtracker:follow'] = 'Suivre des opportunités';
$string['jobtracker:report'] = 'Peiut ajouter des opportunités';
$string['jobtracker:seeopportunities'] = 'Voir les opportunités';
$string['jobtracker:shareelements'] = 'Partager des éléments au niveau site';
$string['jobtracker:viewallopportunities'] = 'Voir les opportunités de tous';
$string['jobtracker:viewpriority'] = 'Voir la priorité de mes opportunités';
$string['jobtracker:viewreports'] = 'Voir les rapports de traitement';
...
$string['addajob'] = 'Ajouter une opportunité';
$string['addanoption'] = 'Ajouter une option';
$string['addawatcher'] = 'Ajouter un observateur ';
$string['addtothejobtracker'] = 'Ajouter à ce traqueur';
...
$string['concluded'] = 'Opportunité gagnée';
$string['contact'] = 'Contact';
$string['contactmail'] = 'Courriel';
...
$string['elementadmin'] = 'Administration des éléments';
$string['elements'] = 'Critères disponibles';
$string['elementsused'] = 'Critères utilisés';
$string['enabletimepart'] = 'Activer l\'heure';
...
$string['errornoaccessalljobs'] = 'Vous n\'avez pas l\'autorisation de voir tous les opportunités.';
$string['errornoaccessjob'] = 'Vous n\'avez pas l\'autorisation de voir cette opportunité.';
$string['errornoeditjob'] = 'Vous n\'avez pas l\'autorisaton de modifier cette opportunité.';
...
$string['finish'] = 'Terminer et revenir à la gestion des éléments';
$string['follow'] = 'Suivre';
$string['followedby'] = 'Assigné à';
$string['follower'] = 'Les opportunités que je suis';
$string['followers'] = 'Responsables';
$string['forusers'] = 'Pour ';
$string['generaltrend'] = 'Tendance';
$string['hassolution'] = 'Cette opporunité a des notes de conclusion';
$string['hasconcluded'] = 'A conclus';
$string['completionhasconcluded'] = 'lorsque le participant a conclu sur une opportunité.';
...
$string['icanfollow'] = 'Je peux suivre des opportunités';
$string['icanmanage'] = 'Je peux gérer les opportunités';
$string['icannotmanage'] = 'Je ne gère pas les opportunités';
$string['icannotreport'] = 'Je ne peux pas déposer des opportunités';
$string['icannotresolve'] = 'Je ne peux pas suivre des opportunités';
$string['icanreport'] = 'Je peux créer des opportunités';
$string['id'] = 'Identifiant';
$string['inworkinmonth'] = 'A résoudre';
$string['jobid'] = 'Opportunité';
$string['jobnumber'] = 'ID';
$string['jobprefix'] = 'Préfixe de l\'opportunité';
$string['jobs'] = 'Opportunités';
$string['jobstoassign'] = 'Opportunités à répartir: {$a}';
$string['jobstowatch'] = 'Opportunités à examiner: {$a}';
$string['jobtracker-levelaccess'] = 'Mes possibilités dans ce gestionnaire ';
$string['jobtracker_name'] = 'Services du gestionnaire d\'opportunités';
$string['jobtracker_service_name'] = 'Services du gestionnaire d\'opportunités';
$string['jobtrackerelements'] = 'Définition du trackeur ';
$string['jobtrackereventchanged'] = 'Changement d\'état de l\'opportunité dans le gestionnaire [{$a}]';
$string['jobtrackername'] = 'Nom du gestionnaire ';
$string['jobedit'] = 'Modifier une opportunité';
$string['knownelements'] = 'Rubriques connues ';
$string['listjobs'] = 'Liste d\'opportunités';
$string['local'] = 'Local';
...
$string['meetingdone'] = 'Rendez-vous effectué';
$string['meetingscheduled'] = 'Rendez-vous planifié';
$string['messageregister'] = 'Vos informations ont été enregistrées.';
$string['modulename'] = 'Gestionnaire d\'opportunités';
$string['modulenameplural'] = 'Gestionnaires d\'opportunités';
$string['month'] = 'Mois';
$string['myassignees'] = 'Les personnes que j\'ai assignées';
$string['myjobs'] = 'Mes opportunités';
...
$string['myfollowed'] = 'Mes stagiaires';
$string['mywork'] = 'Mon travail';
$string['name'] = 'Nom';
$string['namecannotbeblank'] = 'Le nom ne peut pas être laissé vide.';
$string['newelement'] = 'Nouvel élément de formulaire : {$a}';
$string['newjob'] = 'Nouvelle opportunité';
$string['noassignedjobs'] = 'Aucun travail en cours';
...
$string['nojobsreported'] = 'Aucune opportunité déposée';
$string['nojobsconcluded'] = 'Aucune opportunité aboutie';
$string['nojobtrackeradmins'] = 'Pas d\'administrateurs';
$string['nooptions'] = 'Pas d\'option';
$string['noqueryssaved'] = 'Aucune recherche actuellement mémorisée';
$string['noreporters'] = 'Pas de rapporteurs, il n\'y a probablement pas d\'opportunités dans ce gestionnaire.';
$string['noresolvingjob'] = 'Pas d\'opportunité à suivre';
$string['notes'] = 'Notes';
$string['notes'] = 'Notes';
$string['notifications'] = 'Notifications';
$string['nowatches'] = 'Pas d\'abonnements';
$string['numberofjobs'] = 'Nombre d\'opportunités';
...
$string['prefsnote'] = 'Les préférences déterminent quelles sont les notifications que vous recevrez lorsque vous êtes abonné à une opportunité.';
...
$string['raiserequestcaption'] = 'Demande de priorité pour une opportunité';
$string['raiserequesttitle'] = 'Demander à augmenter la priorité';
$string['raisetotop'] = 'En premier';
$string['reason'] = 'Raison ';
$string['register'] = 'S\'abonner à cette opportunité';
$string['registerajob'] = 'Créer une nouvelle opportunité';
...
$string['setoncomment'] = 'NE PAS m\'informer quand un commentaire est ajouté';
$string['setwhenopens'] = 'NE PAS m\'informer quand une opportunité proposée est examinée';
$string['setwhenconcluded'] = 'NE PAS m\'informer quand une opportunité est conclue';
$string['setwhendead'] = 'NE PAS m\'informer quand une opportunité est perdue';
$string['setwhenwaitsevent'] = 'NE PAS m\'informer quand une réponse est attendue';
$string['setwhentorefresh'] = 'NE PAS m\'informer quand une opportunité doit être relancée';
$string['setwhenshortlisted'] = 'NE PAS m\'informer quand une opportunité est choisie en choix prioritaire';
$string['sharing'] = 'Partage';
$string['sharethiselement'] = 'Rendre ce critère global';
$string['shortlist'] = 'Liste prioritaire';
...
$string['site'] = 'Site';
$string['solution'] = 'Notes d\'entretien';
$string['sortorder'] = 'Ordre';
$string['standalone'] = 'Traqueur autonome.';
$string['statehistory'] = 'Etats';
$string['stateprofile'] = 'Etats des opportunités';
$string['status'] = 'Etat';
$string['subjobtrackers'] = 'Sous-gestionnaires ';
$string['submission'] = 'Une nouvelle opportunité a été déposée dans le gestionnaire [{$a}]';
$string['submitbug'] = 'Soumettre l\'opportunité';
$string['sum_concluded'] = 'Opportunitées conclues';
$string['sum_dead'] = 'Opportunités perdues';
$string['sum_meetingscheduled'] = 'Entretiens programmés';
$string['sum_meetingsdone'] = 'Entretiens passés';
$string['sum_open'] = 'Ouverts';
$string['sum_posted'] = 'Déposé';
$string['sum_shortlist'] = 'Shortlist';
$string['sum_torefresh'] = 'A relancer';
$string['sum_total'] = 'Total';
$string['sum_waitingevent'] = 'En attente d\'un retour';
$string['summary'] = 'Résumé';
$string['targetusernotallowed'] = 'Vous ne pouvez pas voir les données de cet utilisateur';
$string['text'] = 'Champ de texte'; // @DYNA
$string['textarea'] = 'Zone de texte'; // @DYNA
$string['timecreated'] = 'Date d\'entrée';
$string['timepicker'] = 'Sélecteur de date';
$string['torefresh'] = 'A relancer';
$string['turneditingoff'] = 'Désactiver l\'édition';
$string['turneditingon'] = 'Activer l\'édition';
$string['type'] = 'Type';
$string['unregisterall'] = 'Me désabonner de toutes les opportunitéss' ;
$string['unsetoncomment'] = 'Les commentaires déposés me sont envoyés';
$string['unsetwhenconcluded'] = 'M\'informer quand les opportunités sont conclues';
$string['unsetwhendead'] = 'M\'informer quand une activité est abandonnée';
$string['unsetwhenmeetingdone'] = 'M\'informer quand un rendez-vous est marqué comme passé';
$string['unsetwhenopens'] = 'M\'informer quand une opportunité et lue';
$string['unsetwhenmeetingscheduled'] = 'M\'informer quand un rendez-vous est marqué comme programmé';
$string['unsetwhenshortlisted'] = 'M\'informer quand une opportunité est choisie en choix prioritaire';
$string['unsetwhentorefresh'] = 'M\'informer quand une opportunité doit être relancée';
$string['unsetwhenwaitsevent'] = 'M\'informer quand une opportunité est mise en attente de retour';
$string['updateelement'] = 'Modifier un élément de formulaire : {$a}';
$string['userid'] = 'Rapporteur';
$string['view'] = 'Opportunités';
$string['waitingevent'] = 'En attente d\'un retour';
$string['watches'] = 'Obs.';
$string['youneedanaccount'] = 'Vous devez posséder un compte dans cet espace pour pouvoir poster';

// help strings

$string['jobtracker_description'] = '<p>La publication de ce service permet à des jobtrackers du site {$a} de cascader leur collecte vers l\'un de vos trackeurs.</p>
...
Le nom sert à identifier l\'élément au niveau technique. Il doit être constitué sans caractères spéciaux, sans accents ni espaces. Le nom n\'apparait à aucun moment sur l\'interface du jobtracker.
...
Le nom sert à identifier l\'option. Il doit être constitué sans caractères spéciaux, sans accents ni espaces. Le nom n\'apparait à aucun moment sur l\'interface du jobtracker. On peut le considérer aussi comme le "code" technique pour cette valeur du critère.
